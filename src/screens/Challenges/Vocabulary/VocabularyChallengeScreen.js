...
Create exactly 2 vocabulary questions testing basic English synonyms for beginners (CEFR {vocabularyLevel}).
Requirements:
...
Create exactly 2 vocabulary questions testing English synonyms for intermediate learners (CEFR {vocabularyLevel}).
Requirements:
...
Create exactly 2 vocabulary questions testing advanced English synonyms for advanced learners (CEFR {vocabularyLevel}).
Requirements:
